...
/** Convert a hiragana string to katakana using the fixed unicode offset. */
...
/** Build one random word (2-4 mora) in the requested script. */
export function makeWord(script) {
...
/** Build a batch of `count` random words. */
export function generateWords(count, script) {
